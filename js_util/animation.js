...
function animation(target, direction, aim_distance, speed, cb = function() {console.log("callback called");} ) {
	...
	target_point_x = null,
	target_point_y = null;
	queueObj.next = function(n_dir, queue_x, speed, cb) {
		this.push({
...
// 示例
animation(document.querySelector('div'), 'right', 100, 5, function() {
	console.log('完成')
}).next('bottom', 200, 5, function() {
	console.log('啦啦1')
}).next('right', 200, 5, function() {
	console.log('啦啦2')
})